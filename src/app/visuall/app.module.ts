...
import { SearchBySequenceChainComponent } from "./operation-tabs/query-tab/custom-queries/search-by-sequence-chain/search-by-sequence-chain.component";
...
@NgModule({
  declarations: [
    ...
    SearchBySequenceChainComponent,
  ],
  imports: [
    BrowserModule,
    HttpClientModule,
